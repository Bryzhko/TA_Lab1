...
public class Steps {
    ...
    public void iShouldSeeAndLinks(String arg0) {
        ...
        Assert.assertTrue(driver.findElement(By.linkText(arg0)).isDisplayed());
    ...
    public void iShouldSeeMessageForFieldOnPage(String arg0) {
        System.out.println(driver.findElement(By.xpath("/html/body/div[1]/main/div/form/*/p[text()='"+arg0+"']")).getText());
    ...
    public void iShouldSeeTheNewBlogListingOnTheHomepage() {
        Assert.assertTrue(driver.findElement(By.xpath("/html/body/main/div/div[1]/div[1]/div[1]/h2[text()='Post title']" + "")).isDisplayed());
        Assert.assertTrue(driver.findElement(By.xpath("/html/body/main/div/div[1]/div[1]/p[text()='Post description']")).isDisplayed());
    }
    ...
    public void iSeeABlogListingOnTheHomepae() {
        ...
        {
            WebElement element = driver.findElement(By.cssSelector(".post-form__title"));
            js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'title123'}", element);
        }
        driver.findElement(By.cssSelector(".post-form__description")).click();
        {
            WebElement element = driver.findElement(By.cssSelector(".post-form__description"));
            js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'hello im eduard'}", element);
        }
        driver.findElement(By.cssSelector(".post-form__button:nth-child(2)")).click();
        driver.findElement(By.cssSelector(".alert__button")).click();
    }
